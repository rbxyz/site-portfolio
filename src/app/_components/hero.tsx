...
export function HeroSection() {
  return (
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden bg-dark-bg">
      ...
      <div className="relative z-10 container px-4 sm:px-6 md:px-8 max-w-7xl">
        <div className="grid items-center gap-8 md:gap-12 lg:grid-cols-2">
          ...
          >
            ...
            <motion.div
              ...
              className="text-primary-500 font-mono text-xs sm:text-sm md:text-base uppercase tracking-wider"
            >
            ...
            <motion.h1
              ...
              className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl xl:text-8xl font-bold leading-tight"
            >
            ...
            <motion.p
              ...
              className="text-accent-gray text-base sm:text-lg md:text-xl max-w-2xl mx-auto lg:mx-0 leading-relaxed"
            >
            ...
            >
              <Link href="/pages/projects" className="w-full sm:w-auto">
                <Button className="group w-full sm:w-auto bg-transparent border-2 border-primary-500 text-white hover:bg-primary-500 hover:text-dark-bg px-6 sm:px-8 py-2.5 sm:py-3 rounded-lg font-semibold transition-all duration-300 flex items-center justify-center gap-2">
                  explore projetos
              ...
              <Link href="/sobre" className="w-full sm:w-auto">
                <Button
                  variant="outline"
                  className="w-full sm:w-auto bg-transparent border border-dark-border text-accent-gray hover:border-primary-500/50 hover:text-primary-500 px-6 sm:px-8 py-2.5 sm:py-3 rounded-lg font-semibold transition-all duration-300"
                >
                  sobre mim
                </Button>
              </Link>
          ...
          >
            <div className="relative">
              ...
              <div className="absolute -inset-2 sm:-inset-4 bg-primary-500/30 rounded-full blur-2xl opacity-75 animate-pulse" />
